...
const exact: Record<string, string> = {
  ...
  "新建 FTP 会话": "New FTP Session",
  "编辑 FTP 会话": "Edit FTP Session",
  "新建 SFTP 会话": "New SFTP Session",
  "编辑 SFTP 会话": "Edit SFTP Session",
  "属性": "Properties",
  "高级": "Advanced",
  "连接属性": "Connection",
  "显示属性": "Display",
  ...
  "初始远程目录": "Initial Remote Directory",
  "匿名登录": "Anonymous Login",
  "被动模式": "Passive Mode",
  "FTP 不加密账号、密码和传输内容；敏感环境请使用 SFTP。": "FTP does not encrypt credentials or transferred content; use SFTP for sensitive environments.",
  ...
  "当前无法保存 SFTP 密码凭据": "Cannot save SFTP password credential",
  "请填写 SFTP 密码": "Fill in SFTP password",
  "当前无法保存 SFTP 密钥密码凭据": "Cannot save SFTP key passphrase credential",
  "当前无法保存 FTP 密码凭据": "Cannot save FTP password credential",
  "请填写 FTP 密码": "Fill in FTP password",
  ...
  "RDP 已在外部窗口中打开": "RDP opened in an external window",
  "当前 RDP 会话使用系统远程桌面客户端。": "This RDP session uses the system Remote Desktop client.",
  "已断开": "Disconnected",
  "最小化": "Minimize",
  "全屏切换": "Maximize",
  "恢复": "Restore",
  ...
  "本机资源": "Local resources",
  "当前连接暂不支持资源监控": "Resource monitoring is unavailable for this connection",
...
const patterns: Array<[RegExp, (match: RegExpMatchArray) => string]> = [
  ...
  [/^(.+) FTP 密码$/, (match) => `${match[1]} FTP Password`],
  [/^(.+) SFTP 密码$/, (match) => `${match[1]} SFTP Password`],
  [/^(.+) SFTP 密钥密码$/, (match) => `${match[1]} SFTP Key Passphrase`],
